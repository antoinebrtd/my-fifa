      ...
      <Fragment>
        ...
        >
          <Link to="/">
            <MenuItem
              style={styles.item}
              leftIcon={<HomeIcon className="muidocs-icon-home" />}
              onClick={() => this.props.closingDrawer()}
            >
              Accueil
            </MenuItem>
          </Link>
          <Link to="/Players">
            <MenuItem
              style={styles.item}
              leftIcon={<PlayerIcon className="muidocs-icon-player" />}
              onClick={() => this.props.closingDrawer()}
            >
              Les joueurs
            </MenuItem>
          ...
          <Link to="/Results">
            <MenuItem
              style={styles.item}
              leftIcon={<ResultIcon className="muidocs-icon-result" />}
              onClick={() => this.props.closingDrawer()}
            >
              Résultats
            </MenuItem>
          ...
          <Link to="/Rankings">
            <MenuItem
              style={styles.item}
              leftIcon={<RankIcon className="muidocs-icon-rank" />}
              onClick={() => this.props.closingDrawer()}
            >
              Classements
            </MenuItem>
          ...
          <MenuItem
            style={styles.item}
            leftIcon={<TrophyIcon className="muidocs-icon-trophy" />}
            onClick={() => this.props.closingDrawer()}
          >
            Trophées
          </MenuItem>
